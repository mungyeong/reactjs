...
import * as postsAPT from "../lib/api/posts";
...
const writePostSaga = createRequestSaga(WRITE_POST, postsAPT.writePost);

const updatePostSaga = createRequestSaga(UPDATE_POST, postsAPT.updatePost);
